...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description:
      'La ancheta perfecta para decir «te amo»: snacks, globo gigante de corazón personalizado, miniglobos decorativos y tarjeta escrita a mano.',
    deliveryTime: 'Entrega en 24 – 48 h',
  ...
  },
  {
    ...
    description:
      'Tarjetas dibujadas y escritas a mano con marcadores y colores. Cada una es única — escribimos el mensaje que tú nos indiques, con la letra y el estilo que prefieras.',
  ...
  },
  {
    ...
    description:
      'Ancheta, tarjeta personalizada y empaque especial en un solo paquete: los snacks que más gustan, un globo temático y una tarjeta pensada para emocionar.',
    deliveryTime: 'Entrega en 24 – 48 h',
  ...
  },
  {
    ...
    description:
      'Globo de corazón rojo con el mensaje que quieras, escrito a mano. El detalle que convierte cualquier entrega en un momento memorable.',
  ...
  },
  {
    ...
    description:
      'Empaque de regalo premium con papel temático, lazo y cinta. Perfecto para elevar cualquier regalo y convertirlo en algo digno de abrir despacio.',
    deliveryTime: 'Listo en 6 h',
    features: ['Papel temático a elección', 'Lazo y cinta incluidos', 'Tarjeta de regalo', 'Sellado con washi tape'],
  },
  {
    id: 'ancheta-cumple',
    ...
    description:
      'La ancheta del cumpleañero: lleva el nombre de la persona festejada en el globo, snacks favoritos, tarjeta con diseño de cumpleaños y decoración de fiesta.',
    deliveryTime: 'Entrega en 24 – 48 h',
  ...
  },
  {
    ...
    description:
      '¿La sorpresa tiene que llegar sin que el destinatario sospeche nada? Nosotros nos encargamos: empacamos, montamos y entregamos. Tú solo esperas el «gracias».',
  ...
  },
  {
    ...
    description:
      'Pide tu regalo por WhatsApp y te acompañamos en todo el proceso: eliges, personalizas y confirmas en minutos. Sin formularios largos, sin complicaciones.',
